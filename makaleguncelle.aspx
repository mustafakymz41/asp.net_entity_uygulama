<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="makaleguncelle.aspx.cs" Inherits="EntityBlog.makaleduzenle" %>
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i>Makale guncelle</a></li>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Makale Güncelle</h3>
                                </div>
                                <!-- /.box-header -->
                                <!-- form start -->
                                <div class="form-horizontal">
                                    ...
                                    <div class="box-footer">
                                        <asp:Button ID="Button1" type="submit" class="btn btn-info" runat="server" Text="Kaydet" />
                                    </div>
                                    <!-- /.box-footer -->
                                </div>
                            </div>
