<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="makaleler.aspx.cs" Inherits="EntityBlog.makaleler" %>
                            ...
                            <div class="col-xs-12">
                                <div class="box">
                                    <div class="box-header">
                                        <a href="makaleekle.aspx" class="btn btn-primary sm">Ekle</a>
                                    </div>
                                    <!-- /.box-header -->
                                    <div class="box-body">
                                        <table id="example2" class="table table-bordered table-hover">
                                            <thead>
                                                ...
                                                <tr>
                                                    <th>Makale Başlık</th>
                                                    <th>Makale Etiketlenme Tarihi</th>
                                                ...
                                                <asp:Repeater ID="Repeater1" runat="server">
                                                    <ItemTemplate>
                                                        <tr>
                                                            ...
                                                            <td><%# Eval("MakaleEtiketlemeTarihi") %></td>
                                                            <td style="text-align: right"><a href="makaleguncelle.aspx?Id=<%# Eval("MakaleId") %>" class="btn btn-success">Düzenle</a>
                                                                <a href="makaleler.aspx?Id=<%# Eval("MakaleId") %>" class="btn btn-danger">Sil</a></td>
                                                        </tr>
                                                    </ItemTemplate>
                                                </asp:Repeater>
                                            </tbody>
