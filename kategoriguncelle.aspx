<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="kategoriguncelle.aspx.cs" Inherits="EntityBlog.kategoriguncelle" %>
                            ...
                            <div class="box">
                                ...
                                <div class="form-horizontal">
                                    ...
                                    <div class="box-footer">
                                        <asp:Button ID="Button1" type="submit" class="btn btn-info" runat="server" Text="Düzenle" OnClick="Button1_Click"  />
                                    </div>
                                    <!-- /.box-footer -->
                                </div>
                            </div>
